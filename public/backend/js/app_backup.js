!(function (n) {
    ...
    // This is my function i want ot understand and change for light and dark and rtl and ltr
    // function t(e) {
    ...
    function t(e) {
        ...
        if (n("#light-mode-switch").prop("checked")  && "light-mode-switch" === e ) {
            ...
            if( n("#rtl-mode-switch").prop("checked") ){
                n("html").attr("dir", "rtl"),
                n("#light-mode-switch").prop("checked", !1),
                n("#bootstrap-style").attr("href", "assets/css/bootstrap-dark-rtl.min.css"),
                n("#app-style").attr("href", "assets/css/app-dark-rtl.min.css"),
                sessionStorage.setItem("is_visited", "dark-mode-switch")
            }else{
                n("html").removeAttr("dir"),
                n("#light-mode-switch").prop("checked", !1),
            ...
            if( n("#light-mode-switch").prop("checked") ){
        ...
        }else if(n("#rtl-mode-switch").prop("checked" , !1 ) && "rtl-mode-switch" === e){
                ...
                if(n("#dark-mode-switch").prop("checked")){
                    ...
                    // n("#dark-mode-switch").prop("checked", !1),
                    // n("#rtl-mode-switch").prop("checked", !1),
                    // n("#light-mode-switch").prop("checked"),
                    // n("#bootstrap-style").attr("href", "assets/css/bootstrap.min.css"),
                    // n("#app-style").attr("href", "assets/css/app.min.css"),
                    // sessionStorage.setItem("is_visited", "light-mode-switch")
                }

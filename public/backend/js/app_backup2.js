!(function (n) {
    ...
    function light_mode_switch() {
        ...
        n("#bootstrap-style").attr("href", "{{asset('backend/css/bootstrap.min.css')}}"),
        n("#app-style").attr("href", "{{asset('backend/css/app.min.css')}}"),
    ...
    function light_rtl_mode_switch(){
        n("html").attr("dir", "rtl"),
        n("#dark-mode-switch").prop("checked", !1),
        n("#bootstrap-style").attr("href", "{{asset('backend/css/bootstrap-rtl.min.css')}}"),
        n("#app-style").attr("href", "{{asset('backend/css/app-rtl.min.css')}}"),
        sessionStorage.setItem("is_visited", "light-mode-switch")
    }
    ...
    function dark_mode_switch(){
        ...
        n("#bootstrap-style").attr("href", "{{asset('backend/css/bootstrap-dark.min.css')}}"),
        n("#app-style").attr("href", "{{asset('backend/css/app-dark.min.css')}}"),
    ...
    function dark_rtl_mode_switch(){
        n("html").attr("dir", "rtl"),
        n("#light-mode-switch").prop("checked", !1),
        n("#bootstrap-style").attr("href", "{{asset('backend/css/bootstrap-dark-rtl.min.css')}}"),
        n("#app-style").attr("href", "{{asset('backend/css/app-dark-rtl.min.css')}}"),
        sessionStorage.setItem("is_visited", "dark-mode-switch")
    }

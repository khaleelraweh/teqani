...
class AboutInstatuteSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $AboutInstatute = AboutInstatute::create(['title' => ['ar' => 'عن المعهد', 'en'    =>  'About Insatatue'], 'content' => ['ar' => ' في سبعينيات القرن الماضي كان اليمن يعاني من نقص شديد في اعداد الكوادر الصحية المؤهلة في مجالات

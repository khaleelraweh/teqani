...
class WebMenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $about_instatute  = WebMenu::create(['title'  => ['ar' => 'عن المعهد', 'en' => 'About Instatute'], 'icon'   => 'fa fa-home', 'link' =>  ['ar' =>    'courses-list/تصميم', 'en'  =>    'courses-list/design'], 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => null]);
        WebMenu::create(['title'  => ['ar' => 'التعريف بالمعهد', 'en' => 'Introduction to the institute'], 'icon'   => 'fa fa-home', 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => $about_instatute->id]);
        ...
        $addmission_registeration  = WebMenu::create(['title'  => ['ar' => 'القبول والتسجيل', 'en' => 'Admission and registration'], 'icon'   => 'fa fa-home', 'link' =>  ['ar' =>    'courses-list/تصميم', 'en'  =>    'courses-list/design'], 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => null]);
        ...
        $Scientific_specializations  = WebMenu::create(['title'  => ['ar' => 'التخصصات العملية', 'en' => 'Scientific specializations'], 'icon'   => 'fa fa-home', 'link' =>  ['ar' =>    'courses-list/تصميم', 'en'  =>    'courses-list/design'], 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => null]);
        ...
        $Media_images  = WebMenu::create(['title'  => ['ar' => 'الوسائط والصور', 'en' => 'Media and images'], 'icon'   => 'fa fa-home', 'link' =>  ['ar' =>    'courses-list/تصميم', 'en'  =>    'courses-list/design'], 'created_by' => 'admin', 'status' => true, 'published_on' => $faker->dateTime(), 'parent_id' => null]);

...
@section('content')
    <div class="card shadow mb-4">
            ...
            @if (count($about_instatutes) <= 0)
                <div class="ml-auto">
                    @ability('admin', 'create_about_instatutes')
                        <a href="{{ route('admin.about_instatutes.create') }}" class="btn btn-primary">
        ...
        {{-- @include('backend.about_instatutes.filter.filter') --}}
                        ...
                        <tr>
                                ...
                                @php
                                    if ($about_instatute->promotional_image != null) {
                                        $about_instatute_img = asset(
                                            'assets/about_instatutes/' . $about_instatute->promotional_image,
                                        );
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('admin.about_instatutes.edit', $about_instatute->id) }}"
                                ...
                                <form action="{{ route('admin.about_instatutes.destroy', $about_instatute->id) }}"

...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="card-naving">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ route('admin.about_instatutes.index') }}">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.about_instatutes.update', $about_instatute->id) }}" method="post"
            ...
            $("#customer_image").fileinput({
                ...
                initialPreview: [
                    @if ($about_instatute->promotional_image != '')
                        "{{ asset('assets/about_instatutes/' . $about_instatute->promotional_image) }}",
                    @endif
                ],
                    ...
                    @if ($about_instatute->promotional_image != '')
                        {
                            ...
                            size: '1111',
                            width: "120px",
                            url: "{{ route('admin.about_instatutes.remove_image', ['about_instatute_id' => $about_instatute->id, '_token' => csrf_token()]) }}",

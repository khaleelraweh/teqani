                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active" id="recent">
                                        ...
                                        <div class="news-block">
                                            <div class="desc">
                                                ...
                                                <span>
                                                    <i class="fa fa-clock-o" aria-hidden="true"></i> oct 31, 2018</span>
                                                <a href="#" class="news-title">Constructing the best-in-class global
                                                    assets</a>
                                            </div>
                                        </div>
                                        <!-- News Block End -->
                                        ...
                                        <div class="news-block">
                                            <div class="desc">
                                                <div class="image">
                                                    <img class="img-responsive" src="assets/images/blog/news-post-2.jpg"
                                                        alt="news-post">
                                                </div>
                                                <span>
                                                    <i class="fa fa-clock-o" aria-hidden="true"></i> oct 31, 2018</span>
                                        ...
                                        <div class="news-block">
                                            <div class="desc">
                                                <div class="image">
                                                    <img class="img-responsive" src="assets/images/blog/news-post-3.jpg"
                                                        alt="news-post">
                                                </div>
                                                <span>
                                                    <i class="fa fa-clock-o" aria-hidden="true"></i> oct 31, 2018</span>
